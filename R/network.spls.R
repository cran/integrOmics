        ...
        show.edge.labels = FALSE, interactive = FALSE, ...) 		
{
    ...
    if (keep.var) {
        ...
        cord.X = cor(object$X[, keep.X], object$variates$X[, 1:ncomp], 
                     use = "pairwise")
        cord.Y = cor(object$Y[, keep.Y], object$variates$X[, 1:ncomp], 
                     use = "pairwise")
        ...
        cord.X = cor(object$X, object$variates$X[, 1:ncomp], use = "pairwise")
        cord.Y = cor(object$Y, object$variates$X[, 1:ncomp], use = "pairwise")
